...
ls(char *path)
{
  ...
  ca:	e8 1a 05 00 00       	call   5e9 <open>
 ...
 102:	e8 fa 04 00 00       	call   601 <fstat>
 ...
 129:	e8 a3 04 00 00       	call   5d1 <close>
 ...
 2b6:	e8 06 03 00 00       	call   5c1 <read>
 ...
 2ce:	e8 fe 02 00 00       	call   5d1 <close>
...
gets(char *buf, int max)
{
 ...
 462:	50                   	push   %eax
 463:	6a 00                	push   $0x0
 465:	e8 57 01 00 00       	call   5c1 <read>
...
stat(char *n, struct stat *st)
{
 ...
 4c8:	e8 1c 01 00 00       	call   5e9 <open>
...
putc(int fd, char c)
{
 ...
 661:	e8 63 ff ff ff       	call   5c9 <write>
...
morecore(uint nu)
{
 ...
 9b0:	50                   	push   %eax
 9b1:	e8 7b fc ff ff       	call   631 <sbrk>
