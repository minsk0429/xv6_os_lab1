...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
      ...
      24:	e8 57 40 00 00       	call   4080 <mkdir>
  ...
  if(chdir("iputdir") < 0){
      ...
      53:	e8 30 40 00 00       	call   4088 <chdir>
  ...
  if(unlink("../iputdir") < 0){
      ...
      82:	e8 e1 3f 00 00       	call   4068 <unlink>
  ...
  if(chdir("/") < 0){
      ...
      b1:	e8 d2 3f 00 00       	call   4088 <chdir>
...
exitiputtest(void)
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     148:	e8 33 3f 00 00       	call   4080 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     177:	e8 0c 3f 00 00       	call   4088 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1a6:	e8 bd 3e 00 00       	call   4068 <unlink>
...
openiputtest(void)
{
  ...
  if(mkdir("oidir") < 0){
     ...
     214:	e8 67 3e 00 00       	call   4080 <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     274:	e8 df 3d 00 00       	call   4058 <open>
...
opentest(void)
{
  ...
  fd = open("echo", 0);
     ...
     325:	e8 2e 3d 00 00       	call   4058 <open>
  ...
  close(fd);
     ...
     357:	e8 e4 3c 00 00       	call   4040 <close>
     35c:	83 c4 10             	add    $0x10,%esp
  fd = open("doesnotexist", 0);
     35f:	83 ec 08             	sub    $0x8,%esp
     362:	6a 00                	push   $0x0
     364:	68 a7 46 00 00       	push   $0x46a7
     369:	e8 ea 3c 00 00       	call   4058 <open>
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     3d7:	e8 7c 3c 00 00       	call   4058 <open>
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     432:	e8 01 3c 00 00       	call   4038 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     46a:	e8 c9 3b 00 00       	call   4038 <write>
  ...
  close(fd);
     ...
     4bb:	e8 80 3b 00 00       	call   4040 <close>
     4c0:	83 c4 10             	add    $0x10,%esp
  fd = open("small", O_RDONLY);
     4c3:	83 ec 08             	sub    $0x8,%esp
     4c6:	6a 00                	push   $0x0
     4c8:	68 f1 46 00 00       	push   $0x46f1
     4cd:	e8 86 3b 00 00       	call   4058 <open>
  ...
  i = read(fd, buf, 2000);
     ...
     504:	e8 27 3b 00 00       	call   4030 <read>
  ...
  close(fd);
     ...
     551:	e8 ea 3a 00 00       	call   4040 <close>
     556:	83 c4 10             	add    $0x10,%esp

  if(unlink("small") < 0){
     559:	83 ec 0c             	sub    $0xc,%esp
     55c:	68 f1 46 00 00       	push   $0x46f1
     561:	e8 02 3b 00 00       	call   4068 <unlink>
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     5e7:	e8 6c 3a 00 00       	call   4058 <open>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     636:	e8 fd 39 00 00       	call   4038 <write>
  ...
  close(fd);
     ...
     677:	e8 c4 39 00 00       	call   4040 <close>
  ...
  fd = open("big", O_RDONLY);
     ...
     689:	e8 ca 39 00 00       	call   4058 <open>
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     6cc:	e8 5f 39 00 00       	call   4030 <read>
  ...
  close(fd);
     ...
     76a:	e8 d1 38 00 00       	call   4040 <close>
     76f:	83 c4 10             	add    $0x10,%esp
  if(unlink("big") < 0){
     772:	83 ec 0c             	sub    $0xc,%esp
     775:	68 28 48 00 00       	push   $0x4828
     77a:	e8 e9 38 00 00       	call   4068 <unlink>
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     805:	e8 4e 38 00 00       	call   4058 <open>
     80a:	83 c4 10             	add    $0x10,%esp
     80d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    close(fd);
     810:	83 ec 0c             	sub    $0xc,%esp
     813:	ff 75 f0             	push   -0x10(%ebp)
     816:	e8 25 38 00 00       	call   4040 <close>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     852:	e8 11 38 00 00       	call   4068 <unlink>
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     8a1:	e8 da 37 00 00       	call   4080 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     8d0:	e8 b3 37 00 00       	call   4088 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     8ff:	e8 84 37 00 00       	call   4088 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     92e:	e8 35 37 00 00       	call   4068 <unlink>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     997:	e8 b4 36 00 00       	call   4050 <exec>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     9cd:	50                   	push   %eax
     9ce:	e8 55 36 00 00       	call   4028 <pipe>
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     a10:	50                   	push   %eax
     a11:	e8 2a 36 00 00       	call   4040 <close>
    ...
    for(n = 0; n < 5; n++){
     ...
     a5d:	50                   	push   %eax
     a5e:	e8 d5 35 00 00       	call   4038 <write>
    ...
    close(fds[1]);
     ...
     aa3:	50                   	push   %eax
     aa4:	e8 97 35 00 00       	call   4040 <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     b30:	50                   	push   %eax
     b31:	e8 fa 34 00 00       	call   4030 <read>
    ...
    close(fds[0]);
     ...
     b6f:	50                   	push   %eax
     b70:	e8 cb 34 00 00       	call   4040 <close>
...
preempt(void)
{
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 3a 34 00 00       	call   4028 <pipe>
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c05:	50                   	push   %eax
     c06:	e8 35 34 00 00       	call   4040 <close>
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c1b:	50                   	push   %eax
     c1c:	e8 17 34 00 00       	call   4038 <write>
    ...
    close(pfds[1]);
     ...
     c41:	50                   	push   %eax
     c42:	e8 f9 33 00 00       	call   4040 <close>
  ...
  close(pfds[1]);
     ...
     c52:	50                   	push   %eax
     c53:	e8 e8 33 00 00       	call   4040 <close>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c6b:	50                   	push   %eax
     c6c:	e8 bf 33 00 00       	call   4030 <read>
  ...
  close(pfds[0]);
     ...
     c93:	50                   	push   %eax
     c94:	e8 a7 33 00 00       	call   4040 <close>
...
mem(void)
{
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     e3c:	e8 07 32 00 00       	call   4048 <kill>
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f14:	e8 1f 31 00 00       	call   4038 <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fe8:	e8 43 30 00 00       	call   4030 <read>
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10a9:	e8 ba 2f 00 00       	call   4068 <unlink>
    ...
    10eb:	e8 68 2f 00 00       	call   4058 <open>
    ...
    1148:	e8 eb 2e 00 00       	call   4038 <write>
  ...
  for(i = 0; i < 2; i++){
    ...
    11c9:	e8 8a 2e 00 00       	call   4058 <open>
    ...
    1237:	e8 f4 2d 00 00       	call   4030 <read>
    ...
    124e:	e8 ed 2d 00 00       	call   4040 <close>
    ...
    127f:	e8 e4 2d 00 00       	call   4068 <unlink>
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    132a:	50                   	push   %eax
    132b:	e8 28 2d 00 00       	call   4058 <open>
    ...
    1359:	e8 e2 2c 00 00       	call   4040 <close>
    ...
    1389:	50                   	push   %eax
    138a:	e8 d9 2c 00 00       	call   4068 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    142a:	50                   	push   %eax
    142b:	e8 28 2c 00 00       	call   4058 <open>
    ...
    149c:	e8 9f 2b 00 00       	call   4040 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    14ea:	50                   	push   %eax
    14eb:	e8 78 2b 00 00       	call   4068 <unlink>
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1541:	e8 12 2b 00 00       	call   4058 <open>
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1596:	e8 bd 2a 00 00       	call   4058 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c6:	e8 9d 2a 00 00       	call   4068 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15f6:	e8 5d 2a 00 00       	call   4058 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1634:	e8 f7 29 00 00       	call   4030 <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1687:	e8 ac 29 00 00       	call   4038 <write>
...
linktest(void)
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    1723:	e8 30 29 00 00       	call   4058 <open>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1758:	e8 db 28 00 00       	call   4038 <write>
  ...
  close(fd);
    ...
    1782:	e8 b9 28 00 00       	call   4040 <close>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1797:	e8 dc 28 00 00       	call   4078 <link>
  ...
  unlink("lf1");
    ...
    17c2:	e8 a1 28 00 00       	call   4068 <unlink>
  ...
  if(open("lf1", 0) >= 0){
    ...
    17d4:	e8 7f 28 00 00       	call   4058 <open>
  ...
  fd = open("lf2", 0);
    ...
    1801:	e8 52 28 00 00       	call   4058 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1839:	e8 f2 27 00 00       	call   4030 <read>
  ...
  close(fd);
    ...
    1863:	e8 d8 27 00 00       	call   4040 <close>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    1878:	e8 fb 27 00 00       	call   4078 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18e8:	e8 8b 27 00 00       	call   4078 <link>
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    195c:	50                   	push   %eax
    195d:	e8 06 27 00 00       	call   4068 <unlink>
    ...
    19a3:	e8 d0 26 00 00       	call   4078 <link>
    ...
    19e9:	e8 8a 26 00 00       	call   4078 <link>
    ...
    19fe:	50                   	push   %eax
    19ff:	e8 54 26 00 00       	call   4058 <open>
    ...
    1a31:	e8 0a 26 00 00       	call   4040 <close>
  ...
  fd = open(".", 0);
    ...
    1a74:	e8 df 25 00 00       	call   4058 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1b2a:	e8 01 25 00 00       	call   4030 <read>
  ...
  close(fd);
    ...
    1b40:	e8 fb 24 00 00       	call   4040 <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    1bfa:	50                   	push   %eax
    1bfb:	e8 58 24 00 00       	call   4058 <open>
    1c00:	83 c4 10             	add    $0x10,%esp
    1c03:	83 ec 0c             	sub    $0xc,%esp
    1c06:	50                   	push   %eax
    1c07:	e8 34 24 00 00       	call   4040 <close>
    ...
    1c17:	50                   	push   %eax
    1c18:	e8 3b 24 00 00       	call   4058 <open>
    1c1d:	83 c4 10             	add    $0x10,%esp
    1c20:	83 ec 0c             	sub    $0xc,%esp
    1c23:	50                   	push   %eax
    1c24:	e8 17 24 00 00       	call   4040 <close>
    ...
    1c34:	50                   	push   %eax
    1c35:	e8 1e 24 00 00       	call   4058 <open>
    1c3a:	83 c4 10             	add    $0x10,%esp
    1c3d:	83 ec 0c             	sub    $0xc,%esp
    1c40:	50                   	push   %eax
    1c41:	e8 fa 23 00 00       	call   4040 <close>
    ...
    1c51:	50                   	push   %eax
    1c52:	e8 01 24 00 00       	call   4058 <open>
    1c57:	83 c4 10             	add    $0x10,%esp
    1c5a:	83 ec 0c             	sub    $0xc,%esp
    1c5d:	50                   	push   %eax
    1c5e:	e8 dd 23 00 00       	call   4040 <close>
...
linkunlink()
{
  ...
  unlink("x");
    ...
    1cfa:	e8 69 23 00 00       	call   4068 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d84:	e8 cf 22 00 00       	call   4058 <open>
    1d89:	83 c4 10             	add    $0x10,%esp
    1d8c:	83 ec 0c             	sub    $0xc,%esp
    1d8f:	50                   	push   %eax
    1d90:	e8 ab 22 00 00       	call   4040 <close>
    ...
    1dc6:	e8 ad 22 00 00       	call   4078 <link>
    ...
    1dd8:	e8 8b 22 00 00       	call   4068 <unlink>
...
bigdir(void)
{
  ...
  unlink("bd");
    ...
    1e35:	e8 2e 22 00 00       	call   4068 <unlink>
  ...
  fd = open("bd", O_CREATE);
    ...
    1e4a:	e8 09 22 00 00       	call   4058 <open>
  ...
  close(fd);
    ...
    1e78:	e8 c3 21 00 00       	call   4040 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ec5:	e8 ae 21 00 00       	call   4078 <link>
  ...
  unlink("bd");
    ...
    1efd:	e8 66 21 00 00       	call   4068 <unlink>
  ...
  for(i = 0; i < 500; i++){
    ...
    1f44:	50                   	push   %eax
    1f45:	e8 1e 21 00 00       	call   4068 <unlink>
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fea:	e8 69 20 00 00       	call   4058 <open>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2068:	e8 13 20 00 00       	call   4080 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2098:	e8 bb 1f 00 00       	call   4058 <open>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20ed:	e8 66 1f 00 00       	call   4058 <open>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2125:	e8 06 1f 00 00       	call   4030 <read>
  ...
  close(fd);
    ...
    215e:	e8 dd 1e 00 00       	call   4040 <close>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2173:	e8 00 1f 00 00       	call   4078 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    219e:	e8 c5 1e 00 00       	call   4068 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21cb:	e8 88 1e 00 00       	call   4058 <open>
  ...
  if(chdir("dd") != 0){
    ...
    21f6:	e8 8d 1e 00 00       	call   4088 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2221:	e8 62 1e 00 00       	call   4088 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    224c:	e8 37 1e 00 00       	call   4088 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    2277:	e8 0c 1e 00 00       	call   4088 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    22a4:	e8 af 1d 00 00       	call   4058 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22dc:	e8 4f 1d 00 00       	call   4030 <read>
  ...
  close(fd);
    ...
    2306:	e8 35 1d 00 00       	call   4040 <close>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2318:	e8 3b 1d 00 00       	call   4058 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2348:	e8 0b 1d 00 00       	call   4058 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2378:	e8 db 1c 00 00       	call   4058 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23a8:	e8 ab 1c 00 00       	call   4058 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23d5:	e8 7e 1c 00 00       	call   4058 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2402:	e8 51 1c 00 00       	call   4058 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2432:	e8 41 1c 00 00       	call   4078 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2462:	e8 11 1c 00 00       	call   4078 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2492:	e8 e1 1b 00 00       	call   4078 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24bd:	e8 be 1b 00 00       	call   4080 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24e8:	e8 93 1b 00 00       	call   4080 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2513:	e8 68 1b 00 00       	call   4080 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    253e:	e8 25 1b 00 00       	call   4068 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2569:	e8 fa 1a 00 00       	call   4068 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2594:	e8 ef 1a 00 00       	call   4088 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25bf:	e8 c4 1a 00 00       	call   4088 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25ea:	e8 79 1a 00 00       	call   4068 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2615:	e8 4e 1a 00 00       	call   4068 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2640:	e8 23 1a 00 00       	call   4068 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    266b:	e8 f8 19 00 00       	call   4068 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2696:	e8 cd 19 00 00       	call   4068 <unlink>
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    26ee:	e8 75 19 00 00       	call   4068 <unlink>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    270f:	e8 44 19 00 00       	call   4058 <open>
    ...
    274e:	e8 e5 18 00 00       	call   4038 <write>
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    285a:	e8 d9 17 00 00       	call   4038 <write>
  ...
  close(fd);
    ...
    2890:	e8 ab 17 00 00       	call   4040 <close>
  ...
  fd = open("bigfile", 0);
    ...
    28a2:	e8 b1 17 00 00       	call   4058 <open>
  ...
  for(i = 0; ; i++){
    ...
    28e8:	e8 43 17 00 00       	call   4030 <read>
  ...
  close(fd);
    ...
    2997:	e8 a4 16 00 00       	call   4040 <close>
  ...
  unlink("bigfile");
    ...
    29c7:	e8 9c 16 00 00       	call   4068 <unlink>
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2a04:	e8 77 16 00 00       	call   4080 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a2f:	e8 4c 16 00 00       	call   4080 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a5f:	e8 f4 15 00 00       	call   4058 <open>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2b08:	e8 73 15 00 00       	call   4080 <mkdir>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2b60:	e8 1b 15 00 00       	call   4080 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2b8b:	e8 f8 14 00 00       	call   4088 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2bb6:	e8 ad 14 00 00       	call   4068 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2be1:	e8 82 14 00 00       	call   4068 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2c0c:	e8 77 14 00 00       	call   4088 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c37:	e8 2c 14 00 00       	call   4068 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c62:	e8 01 14 00 00       	call   4068 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2c8d:	e8 d6 13 00 00       	call   4068 <unlink>
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2cea:	e8 69 13 00 00       	call   4058 <open>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d55:	e8 fe 12 00 00       	call   4058 <open>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d8a:	e8 c9 12 00 00       	call   4058 <open>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2dba:	e8 c1 12 00 00       	call   4080 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2de5:	e8 7e 12 00 00       	call   4068 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e15:	e8 5e 12 00 00       	call   4078 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e40:	e8 23 12 00 00       	call   4068 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2e6d:	e8 e6 11 00 00       	call   4058 <open>
  ...
  fd = open(".", 0);
    ...
    2e9f:	e8 b4 11 00 00       	call   4058 <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb7:	e8 7c 11 00 00       	call   4038 <write>
  ...
  close(fd);
    ...
    2ee0:	e8 5b 11 00 00       	call   4040 <close>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f29:	e8 52 11 00 00       	call   4080 <mkdir>
    ...
    2f54:	e8 2f 11 00 00       	call   4088 <chdir>
  ...
  chdir("/");
    ...
    301a:	e8 69 10 00 00       	call   4088 <chdir>
...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    3120:	6a 00                	push   $0x0
    3122:	e8 79 0f 00 00       	call   40a0 <sbrk>
  ...
  a = sbrk(0);
    ...
    3130:	6a 00                	push   $0x0
    3132:	e8 69 0f 00 00       	call   40a0 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    3149:	6a 01                	push   $0x1
    314b:	e8 50 0f 00 00       	call   40a0 <sbrk>
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    3220:	6a 00                	push   $0x0
    3222:	e8 79 0e 00 00       	call   40a0 <sbrk>
  ...
  p = sbrk(amt);
    ...
    3240:	50                   	push   %eax
    3241:	e8 5a 0e 00 00       	call   40a0 <sbrk>
  ...
  *lastaddr = 99;
  ...
  c = sbrk(0);
    ...
    32c3:	6a 00                	push   $0x0
    32c5:	e8 d6 0d 00 00       	call   40a0 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3329:	6a 00                	push   $0x0
    332b:	e8 70 0d 00 00       	call   40a0 <sbrk>
  ...
  c = sbrk(-(sbrk(0) - oldbrk));
    ...
    33aa:	50                   	push   %eax
    33ab:	e8 f0 0c 00 00       	call   40a0 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3442:	e8 01 0c 00 00       	call   4048 <kill>
  ...
  if(pipe(fds) != 0){
    ...
    346a:	50                   	push   %eax
    346b:	e8 b8 0b 00 00       	call   4028 <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34b4:	6a 00                	push   $0x0
    34b6:	e8 e5 0b 00 00       	call   40a0 <sbrk>
    ...
    34ca:	50                   	push   %eax
    34cb:	e8 d0 0b 00 00       	call   40a0 <sbrk>
    ...
    3512:	52                   	push   %edx
    3513:	50                   	push   %eax
    3514:	e8 17 0b 00 00       	call   4030 <read>
  ...
  c = sbrk(4096);
    ...
    3534:	e8 67 0b 00 00       	call   40a0 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    355e:	50                   	push   %eax
    355f:	e8 e4 0a 00 00       	call   4048 <kill>
  ...
  if(sbrk(0) > oldbrk)
    ...
    359f:	6a 00                	push   $0x0
    35a1:	e8 fa 0a 00 00       	call   40a0 <sbrk>
    ...
    35b1:	6a 00                	push   $0x0
    35b3:	e8 e8 0a 00 00       	call   40a0 <sbrk>
    ...
    35c5:	50                   	push   %eax
    35c6:	e8 d5 0a 00 00       	call   40a0 <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3693:	e8 e0 09 00 00       	call   4078 <link>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    376b:	e8 f8 08 00 00       	call   4068 <unlink>
  ...
  if(pid == 0){
    ...
    37d3:	e8 78 08 00 00       	call   4050 <exec>
  ...
  fd = open("bigarg-ok", 0);
    ...
    384c:	e8 07 08 00 00       	call   4058 <open>
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    39b1:	50                   	push   %eax
    39b2:	e8 a1 06 00 00       	call   4058 <open>
    ...
    39f2:	e8 41 06 00 00       	call   4038 <write>
    ...
    3a2e:	e8 0d 06 00 00       	call   4040 <close>
  ...
  while(nfiles >= 0){
    ...
    3b21:	50                   	push   %eax
    3b22:	e8 41 05 00 00       	call   4068 <unlink>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3c01:	e8 52 04 00 00       	call   4058 <open>
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3c2c:	6a 00                	push   $0x0
    3c2e:	e8 6d 04 00 00       	call   40a0 <sbrk>
...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3cb9:	e8 9a 03 00 00       	call   4058 <open>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ce9:	e8 6a 03 00 00       	call   4058 <open>
    3cee:	83 c4 10             	add    $0x10,%esp
    3cf1:	83 ec 0c             	sub    $0xc,%esp
    3cf4:	50                   	push   %eax
    3cf5:	e8 46 03 00 00       	call   4040 <close>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3ed1:	50                   	push   %eax
    3ed2:	6a 00                	push   $0x0
    3ed4:	e8 57 01 00 00       	call   4030 <read>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3f37:	e8 1c 01 00 00       	call   4058 <open>
...
00004018 <exit2>:
SYSCALL(exit2)
    4018:	b8 16 00 00 00       	mov    $0x16,%eax
    401d:	cd 40                	int    $0x40
    401f:	c3                   	ret    

00004020 <wait2>:
SYSCALL(wait2)
    4020:	b8 17 00 00 00       	mov    $0x17,%eax
    4025:	cd 40                	int    $0x40
    4027:	c3                   	ret    

00004028 <pipe>:
SYSCALL(pipe)
    4028:	b8 04 00 00 00       	mov    $0x4,%eax
    402d:	cd 40                	int    $0x40
    402f:	c3                   	ret    

00004030 <read>:
SYSCALL(read)
    4030:	b8 05 00 00 00       	mov    $0x5,%eax
    4035:	cd 40                	int    $0x40
    4037:	c3                   	ret    

00004038 <write>:
SYSCALL(write)
    4038:	b8 10 00 00 00       	mov    $0x10,%eax
    403d:	cd 40                	int    $0x40
    403f:	c3                   	ret    

00004040 <close>:
SYSCALL(close)
    4040:	b8 15 00 00 00       	mov    $0x15,%eax
    4045:	cd 40                	int    $0x40
    4047:	c3                   	ret    

00004048 <kill>:
SYSCALL(kill)
    4048:	b8 06 00 00 00       	mov    $0x6,%eax
    404d:	cd 40                	int    $0x40
    404f:	c3                   	ret    

00004050 <exec>:
SYSCALL(exec)
    4050:	b8 07 00 00 00       	mov    $0x7,%eax
    4055:	cd 40                	int    $0x40
    4057:	c3                   	ret    

00004058 <open>:
SYSCALL(open)
    4058:	b8 0f 00 00 00       	mov    $0xf,%eax
    405d:	cd 40                	int    $0x40
    405f:	c3                   	ret    

00004060 <mknod>:
SYSCALL(mknod)
    4060:	b8 11 00 00 00       	mov    $0x11,%eax
    4065:	cd 40                	int    $0x40
    4067:	c3                   	ret    

00004068 <unlink>:
SYSCALL(unlink)
    4068:	b8 12 00 00 00       	mov    $0x12,%eax
    406d:	cd 40                	int    $0x40
    406f:	c3                   	ret    

00004070 <fstat>:
SYSCALL(fstat)
    4070:	b8 08 00 00 00       	mov    $0x8,%eax
    4075:	cd 40                	int    $0x40
    4077:	c3                   	ret    

00004078 <link>:
SYSCALL(link)
    4078:	b8 13 00 00 00       	mov    $0x13,%eax
    407d:	cd 40                	int    $0x40
    407f:	c3                   	ret    

00004080 <mkdir>:
SYSCALL(mkdir)
    4080:	b8 14 00 00 00       	mov    $0x14,%eax
    4085:	cd 40                	int    $0x40
    4087:	c3                   	ret    

00004088 <chdir>:
SYSCALL(chdir)
    4088:	b8 09 00 00 00       	mov    $0x9,%eax
    408d:	cd 40                	int    $0x40
    408f:	c3                   	ret    

00004090 <dup>:
SYSCALL(dup)
    4090:	b8 0a 00 00 00       	mov    $0xa,%eax
    4095:	cd 40                	int    $0x40
    4097:	c3                   	ret    
...
000040a0 <sbrk>:
SYSCALL(sbrk)
    40a0:	b8 0c 00 00 00       	mov    $0xc,%eax
    40a5:	cd 40                	int    $0x40
    40a7:	c3                   	ret    

000040a8 <sleep>:
SYSCALL(sleep)
    40a8:	b8 0d 00 00 00       	mov    $0xd,%eax
    40ad:	cd 40                	int    $0x40
    40af:	c3                   	ret    

000040b0 <uptime>:
SYSCALL(uptime)
    40b0:	b8 0e 00 00 00       	mov    $0xe,%eax
    40b5:	cd 40                	int    $0x40
    40b7:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    40d0:	e8 63 ff ff ff       	call   4038 <write>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    441f:	50                   	push   %eax
    4420:	e8 7b fc ff ff       	call   40a0 <sbrk>
