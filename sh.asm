...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      58:	52                   	push   %edx
      59:	50                   	push   %eax
      5a:	e8 c1 0e 00 00       	call   f20 <exec>
  ...
  case REDIR:
    ...
    close(rcmd->fd);
      ...
      8f:	50                   	push   %eax
      90:	e8 7b 0e 00 00       	call   f10 <close>
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      a7:	52                   	push   %edx
      a8:	50                   	push   %eax
      a9:	e8 7a 0e 00 00       	call   f28 <open>
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     133:	50                   	push   %eax
     134:	e8 bf 0d 00 00       	call   ef8 <pipe>
    ...
    if(fork1() == 0){
     ...
     15c:	6a 01                	push   $0x1
     15e:	e8 ad 0d 00 00       	call   f10 <close>
     163:	83 c4 10             	add    $0x10,%esp
      dup(p[1]);
     166:	8b 45 e0             	mov    -0x20(%ebp),%eax
     169:	83 ec 0c             	sub    $0xc,%esp
     16c:	50                   	push   %eax
     16d:	e8 ee 0d 00 00       	call   f60 <dup>
     172:	83 c4 10             	add    $0x10,%esp
      close(p[0]);
     175:	8b 45 dc             	mov    -0x24(%ebp),%eax
     178:	83 ec 0c             	sub    $0xc,%esp
     17b:	50                   	push   %eax
     17c:	e8 8f 0d 00 00       	call   f10 <close>
     181:	83 c4 10             	add    $0x10,%esp
      close(p[1]);
     184:	8b 45 e0             	mov    -0x20(%ebp),%eax
     187:	83 ec 0c             	sub    $0xc,%esp
     18a:	50                   	push   %eax
     18b:	e8 80 0d 00 00       	call   f10 <close>
    ...
    if(fork1() == 0){
     ...
     1b1:	6a 00                	push   $0x0
     1b3:	e8 58 0d 00 00       	call   f10 <close>
     1b8:	83 c4 10             	add    $0x10,%esp
      dup(p[0]);
     1bb:	8b 45 dc             	mov    -0x24(%ebp),%eax
     1be:	83 ec 0c             	sub    $0xc,%esp
     1c1:	50                   	push   %eax
     1c2:	e8 99 0d 00 00       	call   f60 <dup>
     1c7:	83 c4 10             	add    $0x10,%esp
      close(p[0]);
     1ca:	8b 45 dc             	mov    -0x24(%ebp),%eax
     1cd:	83 ec 0c             	sub    $0xc,%esp
     1d0:	50                   	push   %eax
     1d1:	e8 3a 0d 00 00       	call   f10 <close>
     1d6:	83 c4 10             	add    $0x10,%esp
      close(p[1]);
     1d9:	8b 45 e0             	mov    -0x20(%ebp),%eax
     1dc:	83 ec 0c             	sub    $0xc,%esp
     1df:	50                   	push   %eax
     1e0:	e8 2b 0d 00 00       	call   f10 <close>
    ...
    close(p[0]);
     ...
     200:	50                   	push   %eax
     201:	e8 0a 0d 00 00       	call   f10 <close>
     206:	83 c4 10             	add    $0x10,%esp
    close(p[1]);
     209:	8b 45 e0             	mov    -0x20(%ebp),%eax
     20c:	83 ec 0c             	sub    $0xc,%esp
     20f:	50                   	push   %eax
     210:	e8 fb 0c 00 00       	call   f10 <close>
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    if(fd >= 3){
     ...
     2bf:	e8 4c 0c 00 00       	call   f10 <close>
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2d3:	e8 50 0c 00 00       	call   f28 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     32c:	50                   	push   %eax
     32d:	e8 26 0c 00 00       	call   f58 <chdir>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     da1:	50                   	push   %eax
     da2:	6a 00                	push   $0x0
     da4:	e8 57 01 00 00       	call   f00 <read>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     e07:	e8 1c 01 00 00       	call   f28 <open>
...
00000f00 <read>:
SYSCALL(read)
     f00:	b8 05 00 00 00       	mov    $0x5,%eax
     f05:	cd 40                	int    $0x40
     f07:	c3                   	ret    

00000f08 <write>:
SYSCALL(write)
     f08:	b8 10 00 00 00       	mov    $0x10,%eax
     f0d:	cd 40                	int    $0x40
     f0f:	c3                   	ret    
...
00000f18 <kill>:
SYSCALL(kill)
     f18:	b8 06 00 00 00       	mov    $0x6,%eax
     f1d:	cd 40                	int    $0x40
     f1f:	c3                   	ret    

00000f20 <exec>:
SYSCALL(exec)
     f20:	b8 07 00 00 00       	mov    $0x7,%eax
     f25:	cd 40                	int    $0x40
     f27:	c3                   	ret    

00000f28 <open>:
SYSCALL(open)
     f28:	b8 0f 00 00 00       	mov    $0xf,%eax
     f2d:	cd 40                	int    $0x40
     f2f:	c3                   	ret    

00000f30 <mknod>:
SYSCALL(mknod)
     f30:	b8 11 00 00 00       	mov    $0x11,%eax
     f35:	cd 40                	int    $0x40
     f37:	c3                   	ret    

00000f38 <unlink>:
SYSCALL(unlink)
     f38:	b8 12 00 00 00       	mov    $0x12,%eax
     f3d:	cd 40                	int    $0x40
     f3f:	c3                   	ret    

00000f40 <fstat>:
SYSCALL(fstat)
     f40:	b8 08 00 00 00       	mov    $0x8,%eax
     f45:	cd 40                	int    $0x40
     f47:	c3                   	ret    

00000f48 <link>:
SYSCALL(link)
     f48:	b8 13 00 00 00       	mov    $0x13,%eax
     f4d:	cd 40                	int    $0x40
     f4f:	c3                   	ret    

00000f50 <mkdir>:
SYSCALL(mkdir)
     f50:	b8 14 00 00 00       	mov    $0x14,%eax
     f55:	cd 40                	int    $0x40
     f57:	c3                   	ret    

00000f58 <chdir>:
SYSCALL(chdir)
     f58:	b8 09 00 00 00       	mov    $0x9,%eax
     f5d:	cd 40                	int    $0x40
     f5f:	c3                   	ret    

00000f60 <dup>:
SYSCALL(dup)
     f60:	b8 0a 00 00 00       	mov    $0xa,%eax
     f65:	cd 40                	int    $0x40
     f67:	c3                   	ret    
...
00000f70 <sbrk>:
SYSCALL(sbrk)
     f70:	b8 0c 00 00 00       	mov    $0xc,%eax
     f75:	cd 40                	int    $0x40
     f77:	c3                   	ret    

00000f78 <sleep>:
SYSCALL(sleep)
     f78:	b8 0d 00 00 00       	mov    $0xd,%eax
     f7d:	cd 40                	int    $0x40
     f7f:	c3                   	ret    

00000f80 <uptime>:
SYSCALL(uptime)
     f80:	b8 0e 00 00 00       	mov    $0xe,%eax
     f85:	cd 40                	int    $0x40
     f87:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     fa0:	e8 63 ff ff ff       	call   f08 <write>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12ef:	50                   	push   %eax
    12f0:	e8 7b fc ff ff       	call   f70 <sbrk>
