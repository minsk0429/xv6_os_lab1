...
printf(int fd, char *s, ...)
{
  ...
  1e:	e8 6c 03 00 00       	call   38f <write>
...
gets(char *buf, int max)
{
 ...
 228:	50                   	push   %eax
 229:	6a 00                	push   $0x0
 22b:	e8 57 01 00 00       	call   387 <read>
...
stat(char *n, struct stat *st)
{
 ...
 28e:	e8 1c 01 00 00       	call   3af <open>
