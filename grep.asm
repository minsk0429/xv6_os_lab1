...
grep(char *pattern, int fd)
{
  ...
  5d:	6a 01                	push   $0x1
  5f:	e8 50 05 00 00       	call   5b4 <write>
  ...
  dc:	e8 cb 04 00 00       	call   5ac <read>
...
main(int argc, char *argv[])
{
 ...
 165:	6a 00                	push   $0x0
 167:	50                   	push   %eax
 168:	e8 67 04 00 00       	call   5d4 <open>
 ...
 1b9:	e8 fe 03 00 00       	call   5bc <close>
...
gets(char *buf, int max)
{
 ...
 44d:	50                   	push   %eax
 44e:	6a 00                	push   $0x0
 450:	e8 57 01 00 00       	call   5ac <read>
...
stat(char *n, struct stat *st)
{
 ...
 4b3:	e8 1c 01 00 00       	call   5d4 <open>
...
putc(int fd, char c)
{
 ...
 64c:	e8 63 ff ff ff       	call   5b4 <write>
...
morecore(uint nu)
{
 ...
 99b:	50                   	push   %eax
 99c:	e8 7b fc ff ff       	call   61c <sbrk>
