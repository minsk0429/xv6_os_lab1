...
cat(int fd)
{
  ...
  13:	6a 01                	push   $0x1
  15:	e8 98 03 00 00       	call   3b2 <write>
  ...
  49:	e8 5c 03 00 00       	call   3aa <read>
...
main(int argc, char *argv[])
{
  ...
  c2:	6a 00                	push   $0x0
  c4:	50                   	push   %eax
  c5:	e8 08 03 00 00       	call   3d2 <open>
 ...
 113:	e8 a2 02 00 00       	call   3ba <close>
...
gets(char *buf, int max)
{
 ...
 24b:	50                   	push   %eax
 24c:	6a 00                	push   $0x0
 24e:	e8 57 01 00 00       	call   3aa <read>
...
stat(char *n, struct stat *st)
{
 ...
 2b1:	e8 1c 01 00 00       	call   3d2 <open>
...
morecore(uint nu)
{
 ...
 799:	50                   	push   %eax
 79a:	e8 7b fc ff ff       	call   41a <sbrk>
